# Generated by Django 2.2 on 2023-09-24 15:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Management_System', '0023_auto_20230924_1528'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='medical_history',
            name='user',
            field=models.ForeignKey(default=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Management_System.Patient'),
        ),
